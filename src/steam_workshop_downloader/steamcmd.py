    ...
    def __init__(self, install_path):
        ...
        if not os.path.isdir(self.install_path):
            raise SteamcmdException(
                "Install path is not a directory or does not exist: {}".format(
                    self.install_path
                )
            )
        ...
        if self.platform == "Windows":
            ...
            raise SteamcmdException(
                "The operating system is not supported. Expected Linux or Windows, received: {}".format(
                    self.platform
                )
            )
