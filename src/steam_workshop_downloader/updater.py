...
def update_mods_from_game_id(steam_handler: SteamCMD, game_id: str):
    update_mods(
        steam_handler, os.path.join(steam_handler.install_path, "steamapps", "workshop", "content", game_id)
    )


def update_mods_from_game_folder(steam_handler: SteamCMD, folder: str):
    if (
